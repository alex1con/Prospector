...
public class Utils : MonoBehaviour {
	...
	public static Vector3 BoundsInBoundsCheck( Bounds bigB, Bounds lilB, BoundsTest test
		...
		case BoundsTest.center:
			...
			return( off );
			// The onScreen test determines what off would have to be applied to keep all of lilB
			➥inside bigB
...
//============================ Bézier Curves ============================
	...
	static public string AddCommasToNumber(int n) {
		...
		while (n>0) {
			...
			// NOTE: It is somewhat faster to use a StringBuilder or a List<String> which
